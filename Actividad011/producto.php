...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            $sql = "select * from menu where md5(idmenu) = '" . $_REQUEST["idp"] . "'" ;
            //echo $sql;
            ...
            if($resultado->num_rows > 0)
            {
                while($fila = $resultado->fetch_assoc())
                {
                    ...
                    $precioorig = $fila["precio"];
                    $preciopromo = $fila["preciopromocion"];
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="<?= $foto ?>" alt="..." /></div>
                    <div class="col-md-6">
                        <div class="small mb-1">SKU: <?= $sku ?></div>
                        <h1 class="display-5 fw-bolder"><?= $nombreprod ?></h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">$<?= $precioorig ?></span>
                            <span>$<?= $preciopromo ?></span>
                        </div>
                        <p class="lead"><?= $descri ?></p>
                        <div class="d-flex">
        ...
        <section class="py-5 bg-light">
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <?php
                    ...
                    $sql = "select * from menu inner join categoria on categoria.idcategoria = menu.idcategoria inner join unidadmedida on menu.idunidadmedida = unidadmedida.idunidadmedida order by rand() limit 4 ";
